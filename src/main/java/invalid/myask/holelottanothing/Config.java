...
public class Config {
    ...
    public static void synchronizeConfiguration(File configFile) {
        ...
        void_biome_ID = configuration.getInt(
            "void_biome_ID",
            Configuration.CATEGORY_GENERAL,
            void_biome_ID,
            0, Integer.MAX_VALUE,
